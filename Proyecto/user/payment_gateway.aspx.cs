...
public partial class user_payment_gateway : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Response.Write("<input type='hidden' name='business' value='Correo@Correo.com'>");
        Response.Write("<input type='hidden' name='currency_code' value='USD'>");

        Response.Write("<input type='hidden' name='item_name' value='Pago por Compra'>");
        ...
        Response.Write("<input type='hidden' name='return' value='http://localhost:36272/shopping_website/user/payment_succes.aspx?order=" +order_no.ToString() + "'>");
        Response.Write("</form>");
